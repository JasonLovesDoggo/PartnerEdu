...
ADMINS = ["Jason Cameron <fbla.jasoncameron.dev"]
...
# PWA
PWA_APP_NAME = "PartnerEdu"
PWA_APP_DESCRIPTION = (
    "PartnerEdu is a platform that connects schools with organizations to "
    "provide educational experiences for students."
)
PWA_APP_THEME_COLOR = "#99f4c9"
PWA_APP_BACKGROUND_COLOR = "#ededed"
...
PWA_APP_SHORTCUTS = [
    ...
    {"name": "Dashboard", "url": "/dashboard/", "description": "Shortcut to access the dashboard page"},
]
